...
// const divisions = ["manager", "developer", "architect", "tester"]
...
const workersInstances = workers.reduce((workerInstance, worker) => {
    workerInstance[worker.name] = new Worker(worker);
